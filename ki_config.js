...
/* ============================================================
   ...
   · [버튼명, 클래스('primary'|'green'|'danger'|'')]
   · 여기에 없는 그리드 화면은 권한에 따라 자동 산출됩니다.
   · 버튼명은 각 화면의 실제 버튼명과 같아야 자동 실행됩니다.
============================================================ */
const ACTS = {
  'lot-route'  : [['조회','primary'],['신규등록',''],['엑셀(CSV)',''],['인쇄','']],
  'lot-scan'   : [],
  ...
  'daily-check': [['💾 점검 등록','primary'],['전체 양호',''],['새로고침',''],['엑셀(CSV)','']],
  'mold-insp'  : [['💾 점검 등록','primary'],['전체 합격',''],['새로고침',''],['엑셀(CSV)','']],
  'wash-check' : [['💾 세척 등록','primary'],['정기세척 일괄 등록','green'],['새로고침',''],['엑셀(CSV)','']],
  'shot-ledger': [['저장','primary'],['＋ 품번 추가',''],['등급 자동 산정','green'],['새로고침',''],['엑셀(CSV)','']],
  'grade-eval' : [['새로고침','']],
  'tool-due'   : [['지금 점검','primary'],['ntfy 테스트',''],['기준 초기화',''],['엑셀(CSV)','']],
  'mold-spec'  : [['저장','primary'],['새로입력',''],['삭제','danger'],['새로고침',''],['엑셀(CSV)','']],
